...
GvKernelInclude::instance()->includeFile('src/system/template/factory/BaseFileTemplateFactory.inc.php');
GvKernelInclude::instance()->includeFile('src/system/template/Smarty3Template.inc.php');
